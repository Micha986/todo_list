...
def save_file():
    file_name = filedialog.asksaveasfilename(defaultextension=(".txt"), initialdir="/Users/Michael/OneDrive/Desktop/programmieren starten/Tkinter/Modul 12", title="Datei speichern")
    if file_name:
...
def open_file():
    file_name = filedialog.askopenfilename(initialdir="/Users/Michael/OneDrive/Desktop/programmieren starten/Tkinter/Modul 12", title="Datei öffnen")
    if file_name:
